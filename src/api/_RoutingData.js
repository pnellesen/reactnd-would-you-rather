...
export const routeData = [
  ...
  {navTo:'/questions/:question_id', navText:'Question', component: ViewQuestion, isNavItem: false, exact: false},
  {navTo:'/questions', navText:'Question', component: ViewQuestion, isNavItem: false, exact: true},
